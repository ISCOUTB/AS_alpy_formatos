...
// Función auxiliar para mostrar un slider (puedes moverla fuera de la clase si lo prefieres)
public function my_slider($name, $min, $max, $value, $izq_val, $der_val) {
    $slider = '';
...
protected function _get_teacher_content($DB, $COURSE) {
    global $OUTPUT;
